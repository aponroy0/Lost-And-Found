    ...
    >
      ...
      <div className="p-4">
        ...
        <div className="flex items-center gap-2 text-xs text-gray-400">
          <Calendar size={14} />
          {/*
          // Convert the 'PostedAt' timestamp from the item object into a human-readable
          // local date and time string. The Date constructor creates a Date object from
          // the stored value, and toLocaleString() formats it according to the user's
          // regional settings (e.g., "11/4/2025, 3:30:00 PM").         
          */}
          <span>{new Date(item.PostedAt).toLocaleString()}</span>
        </div>
